        ...
        <div class="bg-zinc-800 p-8 rounded-lg shadow-lg border border-zinc-600">
            ...
            <form method="POST" action="/departamentos/{{ $departamento->id }}">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nombre" value="{{ $departamento->nombre }}" required class="w-full bg-zinc-900 border border-zinc-600 rounded p-3 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors">
                </div>

                <div class="mb-8">
                    <label class="block text-sm font-medium text-zinc-300 mb-2">Descripción</label>
                    <textarea name="descripcion" rows="4" class="w-full bg-zinc-900 border border-zinc-600 rounded p-3 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors">{{ $departamento->descripcion }}</textarea>
                </div>
